...
\begin{figure}[!htbp]
    ...
    \caption{Band-energy relative error (dimensionless) vs.\ time $t$ (s), seed 42, LES-derived placement. Bands: low-$k$ ($k\le 5$, sensor-count Nyquist scale), mid-$k$ ($5<k\le 16$), high-$k$ ($k>16$). The $t=0$ frame is excluded.}
    \label{fig:band_err}
\end{figure}
